...
#include <stdint.h>
  ...
  /**********************************************************************************************
   * @section Interrupt Definitions
   **********************************************************************************************/

  /**** @subsection IRQ Interrupt Value Definitions ****/

  static const int32_t COMP_IRQ                   = 152;   /** @brief COMP1 and COMP2. */
  static const int32_t CRS_IRQ                    = 159;   /** @brief Clock recovery system globa. */
  static const int32_t DMA2D_IRQ                  = 105;   /** @brief DMA2D global interrupt. */
  static const int32_t DMAMUX2_OVR_IRQ            = 143;   /** @brief DMAMUX2 overrun interrupt. */
  static const int32_t FMC_IRQ                    = 63;    /** @brief FMC global interrupt. */
  static const int32_t CEC_IRQ                    = 109;   /** @brief HDMI-CEC global interrupt. */
  static const int32_t HSEM0_IRQ                  = 140;   /** @brief HSEM global interrupt 1. */
  static const int32_t JPEG_IRQ                   = 136;   /** @brief JPEG global interrupt. */
  static const int32_t MDMA_IRQ                   = 137;   /** @brief MDMA. */
  static const int32_t QUADSPI_IRQ                = 107;   /** @brief QuadSPI global interrupt. */
  ...
  static const int32_t ADC3_IRQ                   = 142;   /** @brief ADC3 global interrupt. */
  static const int32_t ADC1_2_IRQ                 = 33;    /** @brief ADC1 and ADC2. */
  static const int32_t DMAMUX1_OV_IRQ             = 117;   /** @brief DMAMUX1 overrun interrupt. */
  static const int32_t RCC_IRQ                    = 20;    /** @brief RCC global interrupt. */
  static const int32_t LPUART_IRQ                 = 157;   /** @brief LPUART global interrupt. */
  ...
  static const int32_t DCMI_IRQ                   = 93;    /** @brief DCMI global interrupt. */
  static const int32_t ETH_IRQ                    = 76;    /** @brief Ethernet global interrupt. */
  static const int32_t ETH_WKUP_IRQ               = 77;    /** @brief Ethernet wakeup through EXTI. */
  static const int32_t HRTIM_MST_IRQ              = 118;   /** @brief HRTIM master timer interrupt. */
  static const int32_t HRTIM_FLT_IRQ              = 124;   /** @brief HRTIM fault interrupt. */
  static const int32_t TIM1_BRK_IRQ               = 39;    /** @brief TIM1 break interrupt. */
  static const int32_t TIM1_UP_IRQ                = 40;    /** @brief TIM1 update interrupt. */
  static const int32_t TIM1_TRG_COM_IRQ           = 41;    /** @brief TIM1 trigger and commutation. */
  static const int32_t TIM8_BRK_TIM12_IRQ         = 58;    /** @brief TIM8 and 12 break global. */
  static const int32_t TIM8_UP_TIM13_IRQ          = 59;    /** @brief TIM8 and 13 update global. */
  static const int32_t TIM8_TRG_COM_TIM14_IRQ     = 60;    /** @brief TIM8 and 14 trigger /commutation and global. */
  static const int32_t FDCAN_CAL_IRQ              = 78;    /** @brief CAN2TX interrupts. */
  static const int32_t FDCAN2_IT1_IRQ             = 37;    /** @brief FDCAN2 interrupt 1. */
  static const int32_t MDIOS_WKUP_IRQ             = 134;   /** @brief MDIOS wakeup. */
  static const int32_t MDIOS_IRQ                  = 135;   /** @brief MDIOS global interrupt. */
  static const int32_t SWPMI1_IRQ                 = 130;   /** @brief SWPMI global interrupt. */
  static const int32_t TIM6_DAC_IRQ               = 69;    /** @brief TIM6 global interrupt. */
  static const int32_t FPU_IRQ                    = 96;    /** @brief Floating point unit interrupt. */

  /**** @subsection IRQ Interrupt Array Definitions ****/

  static const int32_t BDMA_CHx_IRQ[9] = {
    [1] = 144,    /** @brief BDMA channel 1 interrupt. */
    [2] = 145,    /** @brief BDMA channel 2 interrupt. */
    [3] = 146,    /** @brief BDMA channel 3 interrupt. */
    [4] = 147,    /** @brief BDMA channel 4 interrupt. */
    [5] = 148,    /** @brief BDMA channel 5 interrupt. */
    [6] = 149,    /** @brief BDMA channel 6 interrupt. */
    [7] = 150,    /** @brief BDMA channel 7 interrupt. */
    [8] = 151,    /** @brief BDMA channel 8 interrupt. */
  };

  static const int32_t I2Cx_EV_IRQ[5] = {
    [1] = 46,     /** @brief I2C1 event interrupt. */
    [2] = 48,     /** @brief I2C2 event interrupt. */
    [3] = 87,     /** @brief I2C3 event interrupt. */
    [4] = 110,    /** @brief I2C4 event interrupt. */
  };

  static const int32_t I2C1_Ex_IRQ[22] = {
    [17] = 47,    /** @brief I2C1 error interrupt. */
  };

  static const int32_t I2Cx_ER_IRQ[5] = {
    [2] = 49,     /** @brief I2C2 error interrupt. */
    [3] = 88,     /** @brief I2C3 error interrupt. */
    [4] = 111,    /** @brief I2C4 error interrupt. */
  };

  static const int32_t SxI4_IRQ[16] = {
    [0]  = 161,    /** @brief SAI4 global interrupt. */
    [15] = 99,     /** @brief SPI4 global interrupt. */
  };

  static const int32_t SAIx_IRQ[5] = {
    [1] = 102,    /** @brief SAI1 global interrupt. */
    [2] = 106,    /** @brief SAI2 global interrupt. */
  ...
  static const int32_t SPIx_IRQ[7] = {
    [1] = 50,     /** @brief SPI1 global interrupt. */
    [2] = 51,     /** @brief SPI2 global interrupt. */
    [3] = 66,     /** @brief SPI3 global interrupt. */
    [5] = 100,    /** @brief SPI5 global interrupt. */
    [6] = 101,    /** @brief SPI6 global interrupt. */
  };

  static const int32_t LPTIMx_IRQ[6] = {
    [1] = 108,    /** @brief LPTIM1 global interrupt. */
    [2] = 153,    /** @brief LPTIM2 timer interrupt. */
    [3] = 154,    /** @brief LPTIM2 timer interrupt. */
    [4] = 155,    /** @brief LPTIM2 timer interrupt. */
    [5] = 156,    /** @brief LPTIM2 timer interrupt. */
  };

  static const int32_t EXTIx_IRQ[5] = {
    [0] = 21,    /** @brief EXTI line 0 interrupt. */
    [1] = 22,    /** @brief EXTI line 1 interrupt. */
    [2] = 23,    /** @brief EXTI line 2 interrupt. */
    [3] = 24,    /** @brief EXTI line 3interrupt. */
    [4] = 25,    /** @brief EXTI line 4interrupt. */
  };

  static const int32_t OTG_xS_EP1_OUT_IRQ[8] = {
    [5] = 113,    /** @brief OTG_FS out global interrupt. */
    [7] = 89,     /** @brief OTG_HS out global interrupt. */
  };

  static const int32_t OTG_xS_EP1_IN_IRQ[8] = {
    [5] = 114,    /** @brief OTG_FS in global interrupt. */
    [7] = 90,     /** @brief OTG_HS in global interrupt. */
  };

  static const int32_t OTG_xS_WKUP_IRQ[8] = {
    [5] = 115,    /** @brief OTG_FS wakeup. */
    [7] = 91,     /** @brief OTG_HS wakeup interrupt. */
  };

  static const int32_t OTG_xS_IRQ[8] = {
    [5] = 116,    /** @brief OTG_FS global interrupt. */
    [7] = 92,     /** @brief OTG_HS global interrupt. */
  };

  static const int32_t DMA_STRx_IRQ[7] = {
    [0] = 26,    /** @brief DMA1 stream0. */
    [1] = 27,    /** @brief DMA1 stream1. */
    [2] = 28,    /** @brief DMA1 stream2. */
    [3] = 29,    /** @brief DMA1 stream3. */
    [4] = 30,    /** @brief DMA1 stream4. */
    [5] = 31,    /** @brief DMA1 stream5. */
    [6] = 32,    /** @brief DMA1 stream6. */
  };

  static const int32_t DMAx_STR7_IRQ[3] = {
    [1] = 62,    /** @brief DMA1 stream7. */
    [2] = 85,    /** @brief DMA2 stream7 interrupt. */
  };

  static const int32_t DMA2_STRx_IRQ[7] = {
    [0] = 71,    /** @brief DMA2 stream0 interrupt. */
    [1] = 72,    /** @brief DMA2 stream1 interrupt. */
    [2] = 73,    /** @brief DMA2 stream2 interrupt. */
    [3] = 74,    /** @brief DMA2 stream3 interrupt. */
    [4] = 75,    /** @brief DMA2 stream4 interrupt. */
    [5] = 83,    /** @brief DMA2 stream5 interrupt. */
    [6] = 84,    /** @brief DMA2 stream6 interrupt. */
  };

  static const int32_t HRTIM_TIMx_IRQ[5] = {
    [0] = 119,    /** @brief HRTIM timer A interrupt. */
    [1] = 120,    /** @brief HRTIM timer B interrupt. */
    [2] = 121,    /** @brief HRTIM timer C interrupt. */
    [3] = 122,    /** @brief HRTIM timer D interrupt. */
    [4] = 123,    /** @brief HRTIM timer E interrupt. */
  };

  static const int32_t DFSDM1_FLTx_IRQ[4] = {
    [0] = 125,    /** @brief DFSDM1 filter 0 interrupt. */
    [1] = 126,    /** @brief DFSDM1 filter 1 interrupt. */
    [2] = 127,    /** @brief DFSDM1 filter 2 interrupt. */
    [3] = 128,    /** @brief DFSDM1 filter 3 interrupt. */
  };

  static const int32_t TIMx_IRQ[18] = {
    [2]  = 43,     /** @brief TIM2 global interrupt. */
    [3]  = 44,     /** @brief TIM3 global interrupt. */
    [4]  = 45,     /** @brief TIM4 global interrupt. */
    [5]  = 65,     /** @brief TIM5 global interrupt. */
    [7]  = 70,     /** @brief TIM7 global interrupt. */
    [16] = 132,    /** @brief TIM16 global interrupt. */
  };

  static const int32_t TIM1x_IRQ[8] = {
    [5] = 131,    /** @brief TIM15 global interrupt. */
    [7] = 133,    /** @brief TIM17 global interrupt. */
  };

  static const int32_t USARTx_IRQ[7] = {
    [1] = 52,    /** @brief USART1 global interrupt. */
    [2] = 53,    /** @brief USART2 global interrupt. */
    [3] = 54,    /** @brief USART3 global interrupt. */
    [6] = 86,    /** @brief USART6 global interrupt. */
  };

  static const int32_t UARTx_IRQ[9] = {
    [4] = 67,    /** @brief UART4 global interrupt. */
    [5] = 68,    /** @brief UART5 global interrupt. */
    [7] = 97,    /** @brief UART7 global interrupt. */
    [8] = 98,    /** @brief UART8 global interrupt. */
  };

  static const int32_t TIMx_CC_IRQ[9] = {
    [1] = 42,    /** @brief TIM1 capture / compare. */
    [8] = 61,    /** @brief TIM8 capture / compare. */
  };

  static const int32_t FDCANx_IT0_IRQ[3] = {
    [1] = 34,    /** @brief FDCAN1 interrupt 0. */
    [2] = 35,    /** @brief FDCAN2 interrupt 0. */
  };

  static const int32_t FDCAN1_ITx_IRQ[2] = {
    [1] = 36,    /** @brief FDCAN1 interrupt 1. */
  };
