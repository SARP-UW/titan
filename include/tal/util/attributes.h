...
#pragma once
   ...
   **************************************************************************************************/
     ...
     */
    #define tal_fn_attr_entry(prio) __attribute__((constructor(prio))) 
   ...
   **************************************************************************************************/
     ...
     * @param msg The warning message to emit.
     */
    #define tal_var_attr_deprecated(msg) __attribute__((deprecated(msg)))

    /**
     * @brief Emits an error (durring compilation) if a variable is accessed.
     * @param msg The error message to emit.
     */
    #define tal_var_attr_unavailable(msg) __attribute__((unavailable(msg)))
     ...
     */
    #define tal_var_attr_aligned(n) __attribute__((aligned(n)))
   ...
   **************************************************************************************************/
     ...
     * @param msg The warning message to emit.
     */
    #define tal_type_attr_deprecated(msg) __attribute__((deprecated(msg)))

    /**
     * @brief Emits an error (durring compilation) if a type is used.
     * @param msg The error message to emit.
     */
    #define tal_type_attr_unavailable(msg) __attribute__((unavailable(msg)))
