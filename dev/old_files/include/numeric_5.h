...
#include <stdbool.h>
  ...
  float tal_mod_f(const float lhs, const float rhs, bool* const err);
  double tal_mod_d(const double lhs, const double rhs, bool* const err);


  // These should be moved to bit
  ...
  uint8_t tal_lshift_u8(const uint8_t lhs, const int32_t rhs, bool* const sat);
  uint16_t tal_lshift_u16(const uint16_t lhs, const int32_t rhs, bool* const sat);
  uint32_t tal_lshift_u32(const uint32_t lhs, const int32_t rhs, bool* const sat);
  uint64_t tal_lshift_u64(const uint64_t lhs, const int32_t rhs, bool* const sat);


  int8_t tal_rshift_i8(const int8_t lhs, const int32_t rhs, bool* const sat);
  int16_t tal_rshift_i16(const int16_t lhs, const int32_t rhs, bool* const sat);
  int32_t tal_rshift_i32(const int32_t lhs, const int32_t rhs, bool* const sat);
  int64_t tal_rshift_i64(const int64_t lhs, const int32_t rhs, bool* const sat);

  uint8_t tal_rshift_u8(const uint8_t lhs, const int32_t rhs, bool* const sat);
  uint16_t tal_rshift_u16(const uint16_t lhs, const int32_t rhs, bool* const sat);
  uint32_t tal_rshift_u32(const uint32_t lhs, const int32_t rhs, bool* const sat);
  uint64_t tal_rshift_u64(const uint64_t lhs, const int32_t rhs, bool* const sat);
  ...
  int8_t tal_cast_i8(const int64_t value, bool* const err);
