...
#define TI_THREAD_MAX_THREADS 10
  #define TI_THREAD_SCHED_FREQ 1000
  #define TI_THREAD_TICK_FREQ 1000
  #define TI_THREAD_MIN_PRIORITY 0
  #define TI_CLK_CPU_FREQ 1000000
