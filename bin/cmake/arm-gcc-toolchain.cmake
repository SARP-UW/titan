...
set(TOOLCHAIN_CACHE_DIR "${CMAKE_CURRENT_LIST_DIR}/toolchain_cache")
...
if (NOT EXISTS ${TOOLCHAIN_EXTRACT_DIR}/bin)
...
list(GET EXTRACTED_TOOLCHAIN_DIRS 0 TOOLCHAIN_BIN_DIR)
...
set(CMAKE_ASM_COMPILER ${TOOLCHAIN_BIN_PATH}/arm-none-eabi-as)
set(CMAKE_OBJCOPY ${TOOLCHAIN_BIN_PATH}/arm-none-eabi-objcopy)
set(CMAKE_OBJDUMP ${TOOLCHAIN_BIN_PATH}/arm-none-eabi-objdump)
set(CMAKE_SIZE ${TOOLCHAIN_BIN_PATH}/arm-none-eabi-size)
